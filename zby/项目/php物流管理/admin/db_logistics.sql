...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3145 DEFAULT CHARSET=gb2312;-- <xjx> --
...
CREATE TABLE `city` (
  ...
  `fatherid` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=346 DEFAULT CHARSET=gbk;-- <xjx> --
...
CREATE TABLE `province` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=gbk;-- <xjx> --
...
CREATE TABLE `tb_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=gb2312;-- <xjx> --
...
CREATE TABLE `tb_car` (
  ...
  `car_used` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=gb2312;-- <xjx> --

-- 表的结构：tb_car_log --
CREATE TABLE `tb_car_log` (
  `log_id` int(10) NOT NULL AUTO_INCREMENT,
  `car_number` varchar(50) NOT NULL,
  `car_log` mediumtext NOT NULL,
  `log_date` datetime NOT NULL,
  `fahuo_id` varchar(50) NOT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=gb2312;-- <xjx> --
...
) ENGINE=MyISAM AUTO_INCREMENT=56 DEFAULT CHARSET=gb2312;-- <xjx> --

-- 表的结构：tb_shopping --
CREATE TABLE `tb_shopping` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `car_number` varchar(50) NOT NULL,
  `fahuo_content` mediumtext NOT NULL,
  `fahuo_id` varchar(50) NOT NULL,
  `fahuo_user` varchar(50) NOT NULL,
  `fahuo_time` datetime NOT NULL,
  `fahuo_ys` varchar(20) DEFAULT '0',
  `fahuo_fk` varchar(20) NOT NULL,
  `car_tel` varchar(50) NOT NULL,
  `shouhuo_user` varchar(50) NOT NULL,
  `shouhuo_address` mediumtext NOT NULL,
  `fahuo_address` mediumtext NOT NULL,
  `fahuo_tel` varchar(50) NOT NULL,
  `shouhuo_tel` varchar(50) NOT NULL,
  `car_log` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=gb2312;-- <xjx> --

-- 表的结构：tran_money --
CREATE TABLE `tran_money` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `qd` varchar(30) NOT NULL,
  `zd` varchar(30) NOT NULL,
  `money` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=gb2312;-- <xjx> --
...
('32','710000','台湾省'),
('33','810000','香港特别行政区'),
('34','820000','澳门特别行政区');-- <xjx> --

-- 表的数据：tb_admin --
INSERT INTO `tb_admin` VALUES
('1','mr','ea01e5fd8e4d8832825acdd20eac5104','0','0'),
('41','678','9fe8593a8a330607d76796b35c64c600','2','0'),
('16','admin','21232f297a57a5a743894a0e4a801fc3','0','0'),
('32','test','ea01e5fd8e4d8832825acdd20eac5104','2','11'),
('33','test1','ea01e5fd8e4d8832825acdd20eac5104','2','11'),
('34','12','ea01e5fd8e4d8832825acdd20eac5104','2','11'),
('39','abb','ea01e5fd8e4d8832825acdd20eac5104','2','0'),
('40','ass','964d72e72d053d501f2949969849b96c','2','0'),
('38','13','ea01e5fd8e4d8832825acdd20eac5104','2','0'),
('42','xiaozhang','202cb962ac59075b964b07152d234b70','2','0'),
('43','999','b706835de79a2b4e80506f582af3676a','2','0'),
('44','t','c4ca4238a0b923820dcc509a6f75849b','2','0'),
('45','122','a0a080f42e6f13b3a2df133f073095dd','2','0'),
('46','777','202cb962ac59075b964b07152d234b70','2','0'),
('47','mm','202cb962ac59075b964b07152d234b70','2','0'),
('48','765','d840cc5d906c3e9c84374c8919d2074e','2','0'),
('49','mn','412566367c67448b599d1b7666f8ccfc','2','0'),
('50','555','81448138f5f163ccdba4acc69819f280','2','0'),
('51','999','fa246d0262c3925617b0c72bb20eeb1d','2','0');-- <xjx> --

-- 表的数据：tb_car --
INSERT INTO `tb_car` VALUES
('40','张四','320332198898433422','吉A-12349','13500000001','长春市','长春 -- 四平','货车','空闲'),
('39','张三','110107199208113144','京A-63554','13534323399','北京市','北京市 -- 浙江省杭州市','货车','空闲'),
('36','李军','222333444666555','鲁B-11111','13500000000','威海','威海 -- 北京市','大货车','空闲'),
('30','鲁鲁','222222222222222222','京A-11114','13511111111','北京市','北京市——哈尔滨','货车','空闲'),
('41','张五','222222222222222','津A-12347','13500000000','天津市','天津市 -- 山东威海','货车','空闲'),
('42','刘刘','222222222222222','浙A-12349','13267859943','浙江省','浙江省杭州市--山东威海','货车','空闲'),
('43','张四','222222222222222','闽A-12333','13500000001','福建省','福建省福州市--山西省太原市','货车','空闲'),
('45','张四','222222222222222','吉A-12349','13500000001','辽宁省','辽宁省沈阳市--吉林省长春市','货车','空闲');-- <xjx> --

-- 表的数据：tb_car_log --
INSERT INTO `tb_car_log` VALUES
('32','京A-63554','轻拿轻放','2015-07-16 10:50:59','2015071610505239'),
('31','京A-63554','轻拿轻放','2015-07-16 10:50:51','2015071610504239'),
('30','京A-63554','轻拿轻放','2015-07-16 10:50:41','2015071610503139'),
('17','吉A-65432','1232132','0000-00-00 00:00:00','20110413140636'),
('12','吉A-12345','闪光灯','0000-00-00 00:00:00','20110409152130'),
('13','吉A-12345','1111','0000-00-00 00:00:00','20110409154713'),
('14','吉A-11111','请小心！！！！！','0000-00-00 00:00:00','20110409160231'),
('19','吉A-11112','请速发货','0000-00-00 00:00:00','2011042810294825'),
('18','吉A-11111','请快速！','0000-00-00 00:00:00','20110415163329'),
('20','吉A-11112',' 山东省','0000-00-00 00:00:00','2011042814070025'),
('29','京A-63554','						轻拿轻放			','2015-07-16 10:50:30','2015071610472039'),
('27','吉A-12349','暂无','2015-07-13 09:54:18','2015071309533040'),
('28','京A-63554','轻拿轻放','2015-07-16 10:47:18','2015071610462439'),
('25','京A-12333','		无	','2015-07-09 08:47:03','20150709084202'),
('26','吉A-12345','31','2015-07-10 04:02:53','2015071004022334'),
('33','京A-63554','轻拿轻放','2015-07-16 10:51:12','2015071610510039'),
('34','京A-63554','轻拿轻放','2015-07-16 10:51:27','2015071610511339'),
('35','京A-63554','轻拿轻放','2015-07-16 10:51:40','2015071610512839'),
('36','津A-12347','无','2015-07-20 10:15:19','2015072010135441');-- <xjx> --

-- 表的数据：tb_customer --
INSERT INTO `tb_customer` VALUES
('17','小李','22222222222','长春'),
('42','33','11111112322','123'),
('9','张**','15555555555','长春市'),
('11','小李','16666666666','长春市'),
('12','小赵','15555555555','长春市'),
('14','小夏','22222222222','大连'),
('30','开元','11111111111','长春'),
('16','小白','77777777777','长春市'),
('25','22','12345678912','2222'),
('19','小白','22222222222','长春'),
('20','小李','22222222222','沈阳'),
('21','小李','22222222222','长春'),
('22','小张','11111111111','电询'),
('24','小李','11111111111','长春'),
('26','小六','22222222222','长春'),
('41','鲁鲁','77777777777','杭州'),
('38','张三','13500000000','长春'),
('43','小张','18463100123','山东威海市'),
('44','1222','13131313131','313'),
('45','老张','18463100111','杭州'),
('46','鲁鲁','18463100857','北京'),
('47','葱葱','18463100222','北京'),
('48','月月','18463100333','北京'),
('49','晨晨','18463100444','北京'),
('50','明明','18463100555','北京'),
('51','伟伟','18463100666','北京'),
('52','浩浩','18463100777','北京'),
('53','灰灰','18463100888','北京'),
('54','张博煜','18463100122','天津');-- <xjx> --

-- 表的数据：tb_shopping --
INSERT INTO `tb_shopping` VALUES
('1','吉A-77777','书籍','2007120309342415','鲁鲁','2007-12-03 09:34:41','1','发货人付款','133333333333','小张','北京','杭州','133333333333','133333333333','123	'),
('8','吉A-11111','文件','2008011014292418','小李','2008-01-10 14:29:56','1','发货人付款','12222222222','李小姐','哈尔滨','长春','13333333333','12222222222',''),
('7','吉A-11111','文件','2008011014192418','小赵','2008-01-10 14:20:13','1','第三方付款','12222222222','李小姐','哈尔滨','长春','15555555555','14444444444',''),
('9','吉A-78665','大连贝壳','20110406023705','小夏','0000-00-00 00:00:00','1','发货人付款','11111111111','小李','吉林长春','大连','22222222222','33333333333',''),
('11','吉A-12345','机箱','20110409145029','小李','0000-00-00 00:00:00','1','发货人付款','13500000000','小赵','四平','长春','22222222222','33333333333',''),
('39','津A-12347','易碎物品轻拿轻放','2015072010135441','张博煜','2015-07-20 10:15:19','0','第三方付款','13500000000','老张','威海','天津','18463100122','18463100888',''),
('14','吉A-11111','机箱','20110409160231','小李','0000-00-00 00:00:00','0','第三方付款','11111111111','随便','沈阳','长春','22222222222','33333333333',''),
('15','吉A-65432','无','20110409160602','小张','0000-00-00 00:00:00','1','发货人付款','11111111111','小李','长春','长春','11111111111','11111111111',''),
('16','吉A-12345','蔬菜','2011040916295922','小李','0000-00-00 00:00:00','1','发货人付款','13500000000','西西','沈阳','长春','11111111111','22222222222',''),
('18','吉A-11111','一车海鲜','20110415163329','小六','0000-00-00 00:00:00','0','发货人付款','11111111111','小小','四平','长春','22222222222','33333333333',''),
('19','吉A-11112','一车大蒜','2011042810294825','开元','0000-00-00 00:00:00','0','发货人付款','22222222222','凯风','哈尔滨','长春','11111111111','22222222222',''),
('28','京A-12333','书籍','20150709084202','小张','2015-07-09 08:47:03','0','第三方付款','18463100122','老张','北京','山东威海市','18463100888','18463100124',''),
('30','吉A-12349','好东西','2015071309533040','老张','2015-07-13 09:54:18','0','发货人付款','13500000001','老鲁','北京','杭州','18463100111','18463111111',''),
('31','京A-63554','书籍','2015071610462439','鲁鲁','2015-07-16 10:47:18','0','发货人付款','13534323399','张张','杭州','北京','18463100857','18463100000',''),
('32','京A-63554','书籍','2015071610472039','葱葱','2015-07-16 10:50:30','0','发货人付款','13534323399','张张','杭州','北京','18463100222','18463100000',''),
('33','京A-63554','书籍','2015071610503139','月月','2015-07-16 10:50:41','0','发货人付款','13534323399','张张','杭州','北京','18463100333','18463100000',''),
('34','京A-63554','书籍','2015071610504239','晨晨','2015-07-16 10:50:51','0','发货人付款','13534323399','张张','杭州','北京','18463100444','18463100000',''),
('35','京A-63554','书籍','2015071610505239','明明','2015-07-16 10:50:59','0','发货人付款','13534323399','张张','杭州','北京','18463100555','18463100000',''),
('36','京A-63554','书籍','2015071610510039','伟伟','2015-07-16 10:51:12','0','发货人付款','13534323399','张张','杭州','北京','18463100666','18463100000',''),
('37','京A-63554','书籍','2015071610511339','浩浩','2015-07-16 10:51:27','0','发货人付款','13534323399','张张','杭州','北京','18463100777','18463100000',''),
('38','京A-63554','书籍','2015071610512839','灰灰','2015-07-16 10:51:40','0','发货人付款','13534323399','张张','杭州','北京','18463100888','18463100000','');-- <xjx> --

-- 表的数据：tran_money --
INSERT INTO `tran_money` VALUES
('1','威海市','北京市','15'),
('2','北京市','杭州市','20'),
('3','天津市','湖南市','20'),
('4','威海市','唐山市','15'),
