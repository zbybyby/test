...
if($_SESSION['admin_user']==true){
	...
	if(isset($_POST['into']))
	{
		...
		echo "<script>alert('发货单修改成功!');window.location.href='indexs.php?lmbs=发货单确认修改';</script>";
	}
?>
<html>
<head>
...
<table  class="ziti" width="685" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#666666">
  ...
  <tr><form name="form1" method="post" action="indexs.php?lmbs=发货单确认修改">
...
<tr>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><input type="submit" name="into"  value="修改！！"></td>
    <td bgcolor="#FFFFFF">&nbsp;</td>
  </tr>
  </form>
</table>
